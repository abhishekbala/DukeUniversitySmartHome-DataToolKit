...
for i = 31:length(onEventsAgg5)-30;
    if or(i == 27494, i == 83717)
        onEventsAgg5(1,i) = 5;
    elseif and(onEventsHVAC2(1,i) == 1,onEventsAgg5(1,i) == 1);
        onEventsAgg5(1,i) = 4;
    elseif and(onEventsHVAC2(1,i) == 1, not(isempty(find(onEventsAgg5(1,i-30:i+30),1))))
        onEventsAgg5(1,i-31 + find(onEventsAgg5(1,i-30:i+30),1)) = 4;
...
onEventsAgg(1,27494) = 1;
onEventsAgg(1,83717) = 1;
