function ROC(truthVals, dataSet, PVV)
...
%% This Section Varies Voting Threshold (Fixed GLR window 30)
% Vals = linspace(1,30,30);
% mSqrD = zeros(size(Vals));
% 
% figure(1);
...
%% This Section Varies the GLR window length (Fixed threshold of 0.8*Window Size)
% Vals = 2:2:100;
% mSqrD = zeros(size(Vals));
% 
% figure(1);
