function [onMatrix, offMatrix] = matForTraining(data, on, off)
...
for i = 1:length(onIndex)
    ...
    onMatrix(i, :) = data(onIndex(1,i)-30:onIndex(1,i)+30,1)';
end
onMatrix;
for i = 1:length(offIndex)
    ...
    offMatrix(i, :) = data(offIndex(1,i)-30:offIndex(1,i)+30,1)';
end
offMatrix;
